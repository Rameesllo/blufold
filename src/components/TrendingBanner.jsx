  ...
  return (
    <section className="py-20 px-6 relative overflow-hidden">
      <div className="container mx-auto">
        <div className="relative min-h-[450px] md:h-[500px] rounded-[40px] overflow-hidden bg-gradient-to-br from-[#050810] via-[#0A0A0A] to-brand-blue/30 flex items-center p-8 md:p-20 border border-brand-blue/20">
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            >
              ...
              <h2 className="text-4xl md:text-7xl font-black text-white tracking-tighter mb-4 md:mb-6 leading-tight">
              ...
              <button className="px-8 py-3 md:px-10 md:py-4 bg-brand-blue text-white font-black rounded-full shadow-[0_0_30px_rgba(41,98,255,0.4)] hover:shadow-[0_0_50px_rgba(41,98,255,0.6)] hover:scale-105 transition-all duration-300 text-sm md:text-base">
                EXPLORE COLLECTION
              </button>
            </motion.div>
          </div>
